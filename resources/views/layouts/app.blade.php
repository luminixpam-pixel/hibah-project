            ...
            <ul class="navbar-nav navbar-left">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="uploadDropdown">
                        <!-- Dokumen: aktif -->
                        <li>
                            <a class="dropdown-item" href="#" id="openPopupBtn">Unggah Dokumen Proposal</a>
                        </li>
                        <!-- Gambar & Lainnya: nonaktif sementara -->
                        <li><a class="dropdown-item disabled" href="#" tabindex="-1" aria-disabled="true">Unggah Evaluasi Penelitian (coming soon)</a></li>
                        <li><a class="dropdown-item disabled" href="#" tabindex="-1" aria-disabled="true">Unggah Laporan Akhir (coming soon)</a></li>
                    </ul>
                </li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle main-nav-link {{ $isMonitoringMenuActive ? 'main-nav-link-active' : '' }}"
                       href="#" id="monitoringDropdown" data-bs-toggle="dropdown">
