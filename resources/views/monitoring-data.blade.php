...
#calendar { background:white; padding:20px; border-radius:18px; box-shadow:0 8px 30px rgba(0,0,0,0.08); }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let calendar = new FullCalendar.Calendar(document.getElementById("calendar"), {
        ...
        eventClick: function(info) {
            ...
            let date = info.event.start.toLocaleDateString("id-ID",{ weekday:"long", day:"numeric", month:"long", year:"numeric" });
