...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::put('/proposal/{proposal}/reject',
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/proposal-disetujui', [ProposalController::class, 'proposalDisetujui'])
        ->name('monitoring.proposalDisetujui');

    Route::get('/proposal-ditolak', [ProposalController::class, 'proposalDitolak'])
